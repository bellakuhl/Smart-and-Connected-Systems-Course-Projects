/* Isabella Kuhl 09/29/19
Adapted from Espressif ADC1 Example
Program displays distance measured by ultrasonic sensor
on console. Minimum distance is ~ 30cm*/
...
void app_main(void)
{
    ...
    while (1) {
        ...
        double distance = adc_reading * 5;  // convert to mm based on sensor datasheet
